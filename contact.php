...
<body>
    ...
    <div class="container_fluide" id="section2">
            <div class="jumbotron text-center">
                <div class="container">
                    <h2 class="jumbotron-heading">Une question ?</h1><br>
                    <h2 class="jumbotron-heading">Un projet ?</h1><br>  
                </div>
            </div>
        </div>
        <section id="contact">
            ...
            <div id="contact-us">
                <div class="container">
                    <div class="row">
                        <div class="heading text-center col-sm-12 col-sm-offset-2  fadeInUp"
