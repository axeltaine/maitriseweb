          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="contact-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                <ul class="address">
                  <li><i class="fa fa-map-marker"></i> <span> Address:</span> 18 A Avenue Georges Corneau, 08000
                    Charleville-Mézières </li>
                  <li><i class="fa fa-phone"></i> <span> Phone:</span> 06.51.47.16.78 </li>
                  <li><i class="fa fa-envelope"></i> <span> Email:</span><a href="a.taine@simplon-charleville.fr">
